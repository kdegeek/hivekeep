 ...
 *
 * Historically this module held the sub-Kin tool *presets* (`applyPreset`,
 ...
 * regardless of toolbox selection (file ops, shell, the sub-Kin reply
 * protocol, human-prompt, notify) — now lives in `@/shared/constants` (the
 * single source of truth, shared with the client Kin tools preview). It is
